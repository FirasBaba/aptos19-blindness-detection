...
if FOLD == -1:
    FOLD = 0
training_folds = [i for i in range(10) if i!=FOLD]
val_folds = [FOLD]
...
train_dataset = APTOSDataset(csv_file='../input/new_folds.csv',
                                   root_dir=['../input/train_images/','../input/2015_data/train/resized_train/'],
                                   image_size=IMAGE_SIZE,
                                   folds=training_folds,
                                   transform=train_transform)

valid_dataset = APTOSDataset(csv_file='../input/new_folds.csv',
                                   root_dir=['../input/train_images/','../input/2015_data/train/resized_train/'],
                                   image_size=IMAGE_SIZE,
                                   folds=val_folds,
